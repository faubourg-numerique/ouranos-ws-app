...
export default {
    ...
    created() {
        ...
        this.capabilities = this.$store.getters["capabilities/getCapabilities"](this.workspace.id);
    }
};
</script>
    ...
    <div class="container my-5">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <RouterLink v-if="$authorization.canStoreCapability(workspace.id)" :to="{ name: 'capabilities.create' }" class="btn btn-primary btn-sm">
