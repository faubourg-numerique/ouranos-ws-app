        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <dl class="row mb-0">
                    ...
                    <dt class="col-sm-4" :class="{ 'mb-0': !service.authorizationRequired }">{{ Utils.capitalize($t("main.context_broker")) }}</dt>
                    <dd class="col-sm-8" :class="{ 'mb-0': !service.authorizationRequired }">
